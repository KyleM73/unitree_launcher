"""Tests for CppRealRobot (C++ pybind11 backend).
...
@pytest.fixture
def config():
    """Minimal Config for CppRealRobot."""
    cfg = Config()
...
class TestGracefulShutdown:
    def test_graceful_shutdown(self, config, fake_unitree):
        ...
        with mock.patch("unitree_launcher.robot.cpp_real_robot.time.sleep") as mock_sleep:
